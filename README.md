...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gqsfb6g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gqsfb6g.containers.anotherwebservice.com/
...
```
git clone git@github.com:youssef-goo/container-gqsfb6g.git
cd container-gqsfb6g
```
...
```
docker attach container-gqsfb6g
```
